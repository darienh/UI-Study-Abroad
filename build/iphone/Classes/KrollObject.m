...
//@interface UIAbroadObject : NSObject
//@end

@interface UIAbroadObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UIAbroadObject class]])
		{
			for (NSString *key in [[(UIAbroadObject*)o modules] allKeys])
			{
