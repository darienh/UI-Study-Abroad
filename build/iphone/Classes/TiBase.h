...
// in simulator we redefine to format for UIAbroad Developer console
...
{\
	NSString * exceptionName = [@"org.uiabroad." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uiabroad";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIUIAbroadNativeItemNone = -1, 
	UIUIAbroadNativeItemSpinner = -2,
	UIUIAbroadNativeItemProgressBar = -3,
	
	UIUIAbroadNativeItemSlider = -4,
	UIUIAbroadNativeItemSwitch = -5,
	UIUIAbroadNativeItemMultiButton = -6,
	UIUIAbroadNativeItemSegmented = -7,
	
	UIUIAbroadNativeItemTextView = -8,
	UIUIAbroadNativeItemTextField = -9,
	UIUIAbroadNativeItemSearchBar = -10,
	
	UIUIAbroadNativeItemPicker = -11,
	UIUIAbroadNativeItemDatePicker = -12,
	
	UIUIAbroadNativeItemInfoLight = -13,
	UIUIAbroadNativeItemInfoDark = -14,
	
	UIUIAbroadNativeItemDisclosure = -15,
	
	UIUIAbroadNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UIAbroad instances of
